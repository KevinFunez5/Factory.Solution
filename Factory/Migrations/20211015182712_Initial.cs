            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MachineId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Designation = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    MaintenancePeriod = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
